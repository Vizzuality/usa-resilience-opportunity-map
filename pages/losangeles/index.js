  ...
  return (
    <div className={styles.section2}>
      <VideoPlayer
        ...
        url="https://youtu.be/zADXQBGfyBo"
      />
    </div>
  );
};
    ...
    <div className={cx(styles.section7, styles.bgWhite)}>
      <div>
        ...
        <div className={cx(styles.col, styles.colRight, styles.textGray)}>
          ...
          <p>
            In its final draft, the Cool Roofs Ordinance &quot;requires
            utilization of cool roofing for new building constructions, building
            additions, and major roof replacements in the unincorporated areas
      ...
      <div>
        <p>
          ...
          <a
            target="_blank"
            rel="noreferrer"
            href="https://newscenter.lbl.gov/2019/08/14/cool-roofs-can-help-shield-californias-cities-against-heat-waves"
          >
        ...
        <p>
          ...
          <a
            target="_blank"
            rel="noreferrer"
            href="https://www.ioes.ucla.edu/project/climate-change-in-the-los-angeles-region"
          >
        ...
        <p>
          ...
          <a
            target="_blank"
            rel="noreferrer"
            href="http://file.lacounty.gov/SDSInter/bos/supdocs/128102.pdf"
          >
...
const LosAngeles = () => {
  return (
    <div className={styles.stories}>
      ...
      <Section12 />
      <Section13 />
      <MetaFooter exploreLink="/explore?id=224804" story="los_angeles" />
    </div>
  );
};
